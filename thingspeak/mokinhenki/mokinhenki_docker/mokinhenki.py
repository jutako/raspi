...
import Adafruit_DHT #from github, for DHT11 and DHT22 sensors
import RPi.GPIO as GPIO #from pip, for PIR pin read
from picamera import PiCamera #from pip, for camera
...
app_token_file = './google_app_token'
dbx_oauth2_token_file = './dbx_accesstoken_mokinhenki'
